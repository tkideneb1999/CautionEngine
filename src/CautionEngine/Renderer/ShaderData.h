...
namespace CautionEngine::Rendering {
	...
	enum CAUTION_ENGINE_CLASS ShaderDepthComp {
		SHADER_DEPTH_COMP_NONE = 0,
		SHADER_DEPTH_COMP_NEVER = 1,
		SHADER_DEPTH_COMP_LESS = 2,
		SHADER_DEPTH_COMP_EQUAL = 3,
		SHADER_DEPTH_COMP_LESS_EQUAL = 4,
		SHADER_DEPTH_COMP_GREATER = 5,
		SHADER_DEPTH_COMP_NOT_EQUAL = 6,
		SHADER_DEPTH_COMP_GREATER_EQUAL = 7,
		SHADER_DEPTH_COMP_ALWAYS = 8,
	};
}